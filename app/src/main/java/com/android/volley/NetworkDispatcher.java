...
public class NetworkDispatcher extends Thread {
    ...
    public void run() {
        if (VolleyLog.DEBUG) {
            VolleyLog.v("NetworkDispatcher started " + Thread.currentThread().getName());
        }
...
//                request.markDelivered();//modify by luo
                mDelivery.postResponse(request, response.source(Response.NETWORK));
