...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    public interface Method {
        ...
        int TRACE = 6;
        int PATCH = 7;
        int DELETE_LOCAL_CACHE = 8;
//        int INVALIDATE_LOCAL_CACHE = 9;
    }

    protected boolean mResponseTwice = true;
    ...
    protected void finish(final String tag) {
        ...
        if (MarkerLog.ENABLED) {
            try {
                ...
                //TODO will crash when post in worker thread
    ...
    public String getUrl() {
        ...
        try {
            if ((mMethod == Method.GET || mMethod == Method.DELETE_LOCAL_CACHE) && getParams().size() != 0) {
...
//        getRequestQueue().getCache().invalidate(getCacheKey(),true);
//    }
    ...
    private Map<String, File> mFileUploads = new HashMap<String, File>();
    ...
    public boolean containsFile() {
        return mFileUploads != null && mFileUploads.size() > 0;
    }
    ...
    public Map<String, MultiPartParam> getMultiPartParams() {
        ...
        HashMap<String, MultiPartParam> mMultipartParams = new HashMap<String, MultiPartParam>();

        Map<String, String> maps = getParams();
        for (Map.Entry<String, String> entry : maps.entrySet()) {
            mMultipartParams.put(entry.getKey(), new MultiPartParam(entry.getValue()));
        }
    ...
    public Request<?> setForceRefresh(boolean forceRefresh) {
    ...
    public final boolean shouldCache() {
        ...
        if (mMethod == Method.GET || mMethod == Method.DELETE_LOCAL_CACHE) {
